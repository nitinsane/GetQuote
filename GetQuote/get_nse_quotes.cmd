cd c:\users\3185401\git\repository\GetQuote
...
"%JAVA_HOME%\bin\java" -cp bin;c:/apps/GSon/gson-2.8.0.jar com.NitinSane.Finance.SecurityQuote.QuoteMain NSE:COLPAL  NSE:LT NSE:PRISMCEM NSE:WOCKPHARMA NSE:ULTRACEMCO NSE:RPOWER NSE:RELINFRA NSE:RELIANCE NSE:RCOM NSE:RELCAPITAL NSE:LML NSE:MTNL NSE:STRTECH NSE:IDBI NSE:ICICIBANK >> NSE_Quotes.txt
