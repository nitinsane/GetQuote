...
"%JAVA_HOME%\bin\java" -cp bin;c:/Apps/gson-2.8.2/gson-2.8.2.jar com.NitinSane.Finance.SecurityQuote.QuoteMain NSE:COLPAL  NSE:LT NSE:PRISMCEM NSE:WOCKPHARMA NSE:ULTRACEMCO NSE:RPOWER NSE:RELINFRA NSE:RELIANCE NSE:RCOM NSE:RELCAPITAL NSE:LML NSE:MTNL NSE:STRTECH NSE:IDBI NSE:ICICIBANK 0P0000XVG6.BSE 0P0000XVE4.BSE 0P00005WF0.BSE 0P00005WLZ.BSE >> NSE_Quotes.txt
